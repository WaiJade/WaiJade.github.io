...
以下教程极其详细，是面对小白的。
<p align="center"><strong>看看电脑博客的样式：</strong></p>
<center><img src="/media/posts/jianzhan/wbza-PC.webp" alt="我不知啊2022年12月29日主页截屏" title="2022年12月29日电脑端截屏" /></center>

<p align="center"><strong>看看手机博客的样式：</strong></p>
<center><img src="/media/posts/jianzhan/wbza-Phone.webp" alt="我不知啊2022年12月29日主页截屏" title="2022年12月29日电脑端截屏" /></center>
...
<p align="center"><strong>下面图文很多，GitHub加载缓慢，请耐心等待呐</strong></p>
### 1. 注册
#### （1）点击右上角的Sign up（注册）
<center><img src="/media/posts/jianzhan/post-JianZhan-1.webp" alt="我不知啊2022年12月29日截屏" title="2022年12月29日电脑端截屏" /></center>

#### （2）输入一个邮箱并点击Continue（继续）
<center>翻译一下：</center>

<blockquote>
  <p align="center"><strong>Enter you email</strong></p>
</blockquote>

<p align="center"><strong>输入您的电子邮件地址</strong></p>
<center><img src="/media/posts/jianzhan/post-JianZhan-2.webp" alt="GitHub2022年12月29日截屏" title="2022年12月29日GitHub截屏" /></center>

#### （3）输入一个密码并点击Continue（继续）
<center>翻译一下：</center>

<blockquote>
  <p align="center"><strong>Create a password</strong></p>
</blockquote>

<p align="center"><strong>创建一个密码</strong></p>
create这个词会在GitHub高频出现请务必记住它。
<center><img src="/media/posts/jianzhan/post-JianZhan-3.webp" alt="GitHub2022年12月29日截屏" title="2022年12月29日GitHub截屏" /></center>
...
<blockquote>
  <p align="center"><strong>Enter a username</strong></p>
</blockquote>

<p align="center"><strong>输入一个用户名</strong></p>
<center><img src="/media/posts/jianzhan/post-JianZhan-4.webp" alt="GitHub2022年12月29日截屏" title="2022年12月29日GitHub截屏" /></center>
...
<blockquote>
  <p align="center"><strong>Would you like to receive product updates and announcements via email? Type "y" for yes or "n" for no</strong></p>
</blockquote>

<p align="center"><strong>您希望通过电子邮件接收产品更新和通知吗？ 输入"y”表示是，输入"n”表示否</strong></p>
<center><img src="/media/posts/jianzhan/post-JianZhan-5.webp" alt="GitHub2022年12月29日截屏" title="2022年12月29日GitHub截屏" /></center>

#### （6）进行人机验证（看你是不是机器）并点击create account（创建账户）
<center>翻译一下：</center>

<blockquote>
  <p align="center"><strong>Verify your account</strong></p>
</blockquote>

<p align="center"><strong>验证你的账户</strong></p>
...
<blockquote>
  <p align="center">You're almost done!<br />We sent a launch code to XXXX@XXXXX.com</p>
  <p align="center">Didn't get your email? Resend the code or update your email address.</p>
</blockquote>

<p align="center"><strong>你快完成了！ 我们发送了一个验证码到XXXX@XXXXX.com<br />Didn't get your email? Resend the code or update your email address.</strong></p>
...
## 二、拉取黄玄先生或者我的模板
### （1）点击左上角的输入框
<center><img src="/media/posts/jianzhan/post-JianZhan-6.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>

#### （2）输入`Cheong-Szesuen.github.io`并按下键盘的<kbd>Enter</kbd>或者<kbd>回车</kbd>
<center><img src="/media/posts/jianzhan/post-JianZhan-7.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>

#### （3）点击`Cheong-Szesuen/Cheong-Szesuen.github.io`
<center><img src="/media/posts/jianzhan/post-JianZhan-8.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>

#### （4）点击右上角的Fork
我的界面可能跟你看到的不太一样，有些是扩展加上去的，不过不需要管它们，fork没有被改，所以直接点fork就行啦
<center><img src="/media/posts/jianzhan/post-JianZhan-9.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>
...
<center><img src="/media/posts/jianzhan/post-JianZhan-10.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>
然后会自己跳转到fork完的页面
<center><img src="/media/posts/jianzhan/post-JianZhan-11.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>

### 三、开始部署GitHub Pages
#### （1）点击上方的Setting（设置）
<center><img src="/media/posts/jianzhan/post-JianZhan-12.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>

#### （2）点击左边的列表中的Pages（页面）
<center><img src="/media/posts/jianzhan/post-JianZhan-13.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>

#### （3）点击Depoly from a branch（从一个分支部署）
<center><img src="/media/posts/jianzhan/post-JianZhan-14.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>

#### （4）点击GitHub Actions
点完后会自动刷新，点完后就是下图这样子
<center><img src="/media/posts/jianzhan/post-JianZhan-15.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>

#### （5）Pages 页面出现下图的样子就是好了
<center><img src="/media/posts/jianzhan/post-JianZhan-16.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>

#### （6）这时候在浏览器的地址栏输入==你的GitHub名字.github.io==就会出现页面

#### 如果出现下面的页面，请检查仓库名或者输入的地址
<center><img src="/media/posts/jianzhan/post-JianZhan-18.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>
...
<center><img src="/media/posts/jianzhan/post-JianZhan-19.webp" alt="GitHub2022年12月30日截屏" title="2022年12月30日GitHub截屏" /></center>
...
header-img: "media/site/home-bg.webp"   # 这是首页的背景图片
...
sidebar-avatar: /media/site/Cheong Szesuen.jpg # 使用绝对路径，绝对路径是从根目录的文件夹开始直到目标的文件路径
```
###### 好友（友情链接）
```
# Friends
...
header-img: "media/site/about-bg.webp"
header-mask: 0.3
multilingual: true
```
###### （3）archive.html文件
...
header-img: "media/site/archive-bg.webp"
```
###### （4）404.html文件
...
<center><img src="/media/posts/jianzhan/post-JianZhan-20.webp" alt="freenom资源解压内容" title="freenom资源解压内容" /></center>
...
###### (1)点击浏览器右上角的菜单
<center><img src="/media/posts/jianzhan/post-JianZhan-21.webp" alt="Edge如何安装扩展" title="Edge如何安装扩展" /></center>

###### (2)点击扩展
<center><img src="/media/posts/jianzhan/post-JianZhan-22.webp" alt="Edge如何安装扩展" title="Edge如何安装扩展" /></center>

###### (3)打开Microsoft Edge加载项
<center><img src="/media/posts/jianzhan/post-JianZhan-23.webp" alt="Edge如何安装扩展" title="Edge如何安装扩展" /></center>

###### (4)搜索`Gooreplacer`，并安装
<center><img src="/media/posts/jianzhan/post-JianZhan-24.webp" alt="Edge如何安装扩展" title="Edge如何安装扩展" /></center>

###### (4)搜索`Header Editor`，选择后边带有FirefoxBar的版本并安装
<center><img src="/media/posts/jianzhan/post-JianZhan-25.webp" alt="Edge如何安装扩展" title="Edge如何安装扩展" /></center>

##### 2.对于Chrome的过程
###### (1)点击浏览器右上角 ⋮ > 更多工具 > 点击扩展程序
<center><img src="/media/posts/jianzhan/post-JianZhan-26.webp" alt="Chrome如何安装扩展" title="Chrome如何安装扩展" /></center>

###### (2)在扩展中心打开右上角的`开发者模式`按钮，然后刷新页面，将下载好的两个插件的文件夹直接拖入浏览器
<center><img src="/media/posts/jianzhan/post-JianZhan-27.webp" alt="Chrome如何安装扩展" title="Chrome如何安装扩展" /></center>
...
<center><img src="/media/posts/jianzhan/post-JianZhan-28.webp" alt="设置Header Editor" title="设置Header Editor" /></center>

###### (2)点击`管理`
<center><img src="/media/posts/jianzhan/post-JianZhan-29.webp" alt="设置Header Editor" title="设置Header Editor" /></center>

###### (3)点击`导出和导入`
<center><img src="/media/posts/jianzhan/post-JianZhan-30.webp" alt="设置Header Editor" title="设置Header Editor" /></center>

###### (4)点击`导入`并找到下载的`HE-GoogleRedirect.json`文件
<center><img src="/media/posts/jianzhan/post-JianZhan-31.webp" alt="设置Header Editor" title="设置Header Editor" /></center>

###### (5)选中`HE-GoogleRedirect.json`，点击`打开`
<center><img src="/media/posts/jianzhan/post-JianZhan-32.webp" alt="设置Header Editor" title="设置Header Editor" /></center>

###### (6)点击保存，成功
<center><img src="/media/posts/jianzhan/post-JianZhan-33.webp" alt="设置Header Editor" title="设置Header Editor" /></center>

##### 4. 开始注册
###### （1）进入网站
进入[Freenom](https://my.freenom.com/domains.php)，速度比较慢，务必耐心，注册完就不经常用它了。
<center><img src="/media/posts/jianzhan/post-JianZhan-34.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

###### （2）搜索需要的域名
①在`Find your new domain`处输入域名（可以不带顶级域名）<br />
②再按<kbd>Enter</kbd>键。
比如我要注册`wbza.gq`，我输入`wbza`，再按<kbd>Enter</kbd>键。出现下面的页面。
<center><img src="/media/posts/jianzhan/post-JianZhan-35.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

第一个右边没有`Get it now!`是因为这是我现在的BLOG地址，被我占用了。

###### （3）选择需要的域名进入cart（购物车）
点击右边的`Get it now!`出现下面的就是加入cart（购物车）了。购物车是我自己意译的，感觉功能差不多。
<center><img src="/media/posts/jianzhan/post-JianZhan-36.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

这样就是说明不能用，以及有人注册过了（因为这是我现在的BLOG地址，被我占用了）
<center><img src="/media/posts/jianzhan/post-JianZhan-37.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

你可以把几种免费的都加入购物车，我觉得没什么必要，就不了。不要贪心！滥用会被举报！

###### （4）点击Checkout
<center><img src="/media/posts/jianzhan/post-JianZhan-38.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

###### （5）选择时间
①选择12个月
<center><img src="/media/posts/jianzhan/post-JianZhan-39.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

②点continue。
<center><img src="/media/posts/jianzhan/post-JianZhan-40.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

一次搞好，Freenom加载慢，难管理。

###### （6）输入并验证邮箱
①在`Enter Your Email Address`（输入您的电子邮箱地址）处输入一个邮箱地址（可能会在垃圾邮件里，如果没收到请查看插件在不在，地址对不对，垃圾邮件有没有）。
<center><img src="/media/posts/jianzhan/post-JianZhan-41.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

②点击`Verify My Email Address`（验证我的电子邮箱地址）然后你会收到一封像下面图片所示邮件一样的邮件（这是我之前注册的时候的邮件）
③点击激活链接（中间最长的那个）
<center><img src="/media/posts/jianzhan/post-JianZhan-42.webp" alt="freenom注册域名" title="freenom注册域名" /></center>
...
<center><img src="/media/posts/jianzhan/post-JianZhan-43.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

###### （8）查看订单
我倒是没收到邮件，但是不影响注册域名。
点击`Click here to go to your Client Area`（点击这里进入你的客户区）
<center><img src="/media/posts/jianzhan/post-JianZhan-44.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

###### （9）查看注册的域名
①点击导航栏的`Services`（服务）
<center><img src="/media/posts/jianzhan/post-JianZhan-45.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

②再点`My Domains`（我的域名）会跳转到域名管理页面上
<center><img src="/media/posts/jianzhan/post-JianZhan-46.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

###### （10）管理域名
在这里会看到你拥有的所有域名，
<center><img src="/media/posts/jianzhan/post-JianZhan-47.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

①点击`Mange Domain`（管理域名）
<center><img src="/media/posts/jianzhan/post-JianZhan-48.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

②点击`Management Tools`选择`Nameservsers`
<center><img src="/media/posts/jianzhan/post-JianZhan-49.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

③选择`use custom nameservers（enter below）`
<center><img src="/media/posts/jianzhan/post-JianZhan-50.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

④在`Nameserver 1`处输入`deborah.ns.cloudflare.com`<br />
⑤在`Nameserver 2`处输入`matias.ns.cloudflare.com`
<center><img src="/media/posts/jianzhan/post-JianZhan-51.webp" alt="freenom注册域名" title="freenom注册域名" /></center>

⑥点击`Change Nameservers`
<center><img src="/media/posts/jianzhan/post-JianZhan-52.webp" alt="freenom注册域名" title="freenom注册域名" /></center>
