...
const featureConfig = [
  ...
  },
  {
    key: "showComments",
    label: "Comments",
    description: "控制文章页评论区是否渲染。",
    icon: "message",
  },
  {
    key: "showFooter",
    label: "Footer",
    description: "控制页面底部页脚是否真正渲染。",
    icon: "footer",
  },
...
function hasPendingChanges() {
  ...
  if (
    ...
    (pendingFeatures.showNotes !== currentState.features.showNotes ||
      ...
      pendingFeatures.showComments !== currentState.features.showComments ||
      pendingFeatures.showFooter !== currentState.features.showFooter)
  ) {
    return true;
  }
